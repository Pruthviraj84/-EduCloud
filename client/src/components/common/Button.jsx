...
export const Button = ({
  ...
  const variants = {
    ...
    danger: 'bg-gradient-to-r from-rose-600 to-red-600 hover:from-rose-500 hover:to-red-500 text-white focus:ring-red-500',
    outline: 'border border-blue-500/40 text-blue-400 hover:bg-blue-500/10 focus:ring-blue-500',
